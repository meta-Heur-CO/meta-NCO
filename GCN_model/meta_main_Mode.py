...
if notebook_mode==False:
    ...
    parser.add_argument('-c','--config', type=str, default="configs/mode/meta_config.json")
...
for task in tasks_list:
    config_path_tasks = "configs/mode/tsp30_mode{}".format(task)+'.json'#args.config
...
def test(net_meta, config_meta, config_task, master_bar, mode='test', num_fine_tune_steps=1000):
...
# replacing with validaiton dataaset
    elif mode == 'test':
