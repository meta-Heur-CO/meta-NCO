...
if notebook_mode==False:
    ...
    parser.add_argument('-c','--config', type=str, default="configs/scaling_50/meta_config.json")
...
for task in tasks_list:
    config_path_tasks = "configs/scaling_50/tsp50_scale"+str(task)+'.json'#args.config
