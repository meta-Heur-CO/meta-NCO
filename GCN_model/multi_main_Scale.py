...
if notebook_mode==False:
    ...
    parser.add_argument('-c','--config', type=str, default="configs/scaling_multi_50/multi_config.json")
...
for task in tasks_list:
    config_path_tasks = "configs/scaling_multi_50/tsp50_scale"+str(task)+'.json'
