...
def mean_tour_len_nodes(x_edges_values, bs_nodes, return_all_tour_lens=False):
    """
    ...
    if (return_all_tour_lens == True):
        return running_tour_len / y.shape[0], np.array(all_tour_lens)
